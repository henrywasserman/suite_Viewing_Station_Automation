...
def main():
    try:
        ...
        test.log("Activate Digicount Low Control")
        ...
        shared.spritecanvas.runSampleInOpenModeAndSimulateBarcode("S1401001L", sample_2)
        ...
        test.log("Step #" + str(step_counter)); step_counter += 1
        accession_number = shared.digicounttab.getAccessionNumberByLevel("Low")
