...
def main():
    ...
    try:
        ...
        test.log("Activate DigiCount™ High Control")
        step_counter = 50
        ...
        shared.spritecanvas.runSampleInOpenModeAndSimulateBarcode("S1401001H", sample_2)
        ...
        #Confirm the High DigiCount™ sample is now active as indicated in the message below the Control combobox
        shared.digicounttab.confirmActiveHighLabelExists()        
